                    ...
                    <table class="result-tab" width="100%">
                        ...
                        @foreach($data AS $row)
                            ...
                            <!--<td><img width = "80px" height="30px" alt="picture" src="/{{url('QtIcon.png')}}"  ></td>-->
                                ...
                                <td>
                                    <?php $id =  $row->id;?>
                                    <a class = "link-info" href = "{{url('admin/park/infoDay/'.$id)}}">日运营情况</a>
                                    <a class = "link-money" href = "{{url('admin/park/moneyDay/'.$id)}}">日收入情况</a>
                                        <a class = "link-info" href = "{{url('admin/park/infoMonth/'.$id)}}">月运营情况</a>
                                        <a class = "link-money" href = "{{url('admin/park/moneyMonth/'.$id)}}">月收入情况</a>
