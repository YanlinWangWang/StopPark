            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <div ><p style="text-align:center;"> 停车场日收益统计</p>
                            <p>金额</p>
                            <p style=" width: 24Px; height :24px; float:left;word-spacing: 1em;"> &nbsp; 20 &nbsp;  15 &nbsp;  10 &nbsp; 5&nbsp; </p>
                      <canvas id="background"  width="1" height="1"></canvas>
                                <canvas   id="canvas"  width="800" height="300" ></canvas>


                            <p style="word-spacing: 3em">   &nbsp;  &nbsp;0.00-6.00 &nbsp;6.00-12.00
                                &nbsp;12.00-18.00&nbsp; 18.00-24.00   时间</p>
                            <br>
                        </div>
                </div>
            </form>
