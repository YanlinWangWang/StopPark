            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <div  ><p style="text-align: center"> 停车场月收益统计</p>
                            <p>金额</p>
                            <div style="width:24px;height:24px;float:left;margin-top:1px; word-spacing: 1em;">50 &nbsp; 40 &nbsp; 30 &nbsp;  20 &nbsp;
                                10 &nbsp; </div>
                            <div class="c">
                                <canvas id="background" width="3" height="3"></canvas>
                                <canvas id="canvas" width="800" height="300"></canvas>
                            </div>
                            <div >

                            <p style="word-spacing: 4em;"> &nbsp;&nbsp;&nbsp;1-7&nbsp;  8-14&nbsp;
                                15-21&nbsp; 22-28 号数</p>
                            <br>
                            </div>
                        </div>
