            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <div >
                           <p style="text-align:center;"> 停车场月停车车辆统计</p>
                                <p> 数量</p>
                            <p style="width:24px ;height:24px;float:left;word-spacing: 1em;">100 &nbsp; 80 &nbsp; 60 &nbsp; 40 &nbsp; 20 &nbsp;  </p>
                                <div class="c">
                                    <canvas id="background" width="8" height="3"></canvas>
                                    <canvas id="canvas" width="800" height="300"></canvas>
                                </div>

                                <p style="word-spacing: 3em;">  &nbsp;&nbsp;&nbsp;&nbsp;1-7  &nbsp; 8-14&nbsp;&nbsp;15-21
                                      &nbsp;  21-28      号数</p>
